...
# and time-and-a-half for the hourly rate for all hours 
...
# Use 75 hours and a rate of 10.50 per hour to test the program 
# (the pay should be 971.25). You should use input to read a string 
